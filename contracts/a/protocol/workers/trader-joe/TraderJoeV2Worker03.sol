...
/// @title TraderJoeV2Worker03 is a worker with reinvest-optimized and beneficial vault buyback functionalities
contract TraderJoeV2Worker03 is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker03 {
  /// @notice Libraries
  ...
  function initialize(
    ...
    pid = _pid;
    (IERC20 _lpToken, , , ,) = masterChefJoeV2.poolInfo(_pid);
