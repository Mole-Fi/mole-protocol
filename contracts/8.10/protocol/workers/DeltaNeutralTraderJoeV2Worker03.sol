...
/// @title DeltaNeutralTraderJoeV2Worker03 is a TraderJoeV2Worker03 worker with reinvest-optimized and beneficial vault buyback functionalities
contract DeltaNeutralTraderJoeV2Worker03 is OwnableUpgradeable, ReentrancyGuardUpgradeable, IWorker03 {
  /// @notice Libraries
  ...
  function initialize(
    ...
    pid = _pid;
    (ERC20Upgradeable _lpToken, , , ,) = masterChefJoeV2.poolInfo(_pid);
