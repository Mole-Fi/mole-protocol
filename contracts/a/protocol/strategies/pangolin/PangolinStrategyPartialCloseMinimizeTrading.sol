...
contract PangolinStrategyPartialCloseMinimizeTrading is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  event LogPangolinStrategyPartialCloseMinimizeTrading(
  ...
  /// @param _router The Pangolin Router smart contract.
  /// @param _wNativeRelayer The relayer to support native transfer
  function initialize(IPangolinRouter _router, IWNativeRelayer _wNativeRelayer) external initializer {
  ...
  function execute(
    ...
    emit LogPangolinStrategyPartialCloseMinimizeTrading(baseToken, farmingToken, lpTokenToLiquidate, lessDebt);
  }
