...
contract TraderJoeStrategyPartialCloseMinimizeTrading is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  event LogTraderJoeStrategyPartialCloseMinimizeTrading(
  ...
  /// @param _router The TraderJoe Router smart contract.
  /// @param _wNativeRelayer The relayer to support native transfer
  function initialize(IJoeRouter02 _router, IWNativeRelayer _wNativeRelayer) external initializer {
  ...
  function execute(
    ...
    emit LogTraderJoeStrategyPartialCloseMinimizeTrading(baseToken, farmingToken, lpTokenToLiquidate, lessDebt);
  }
