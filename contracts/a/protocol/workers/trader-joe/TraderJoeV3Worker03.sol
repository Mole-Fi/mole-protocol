...
/// @title TraderJoeV3Worker03 is a worker with reinvest-optimized and beneficial vault buyback functionalities
contract TraderJoeV3Worker03 is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker03 {
  /// @notice Libraries
  ...
  function initialize(
    ...
    pid = _pid;
    (IERC20 _lpToken, , , ,) = masterChefJoeV3.poolInfo(_pid);
