...
contract TraderJoeStrategyPartialCloseLiquidate is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  event LogTraderJoeStrategyPartialCloseLiquidate(
  ...
  function execute(
    ...
    emit LogTraderJoeStrategyPartialCloseLiquidate(baseToken, farmingToken, lpTokenToLiquidate, lessDebt);
  }
