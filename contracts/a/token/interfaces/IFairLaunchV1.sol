...
interface IFairLaunchV1 {
  ...
  struct PoolInfo {
    ...
    uint256 accMolePerShare;
    uint256 accMolePerShareTilBonusEnd;
  }

  // Information query functions
  function molePerBlock() external view returns (uint256);
  ...
  // OnlyOwner functions
  function setMolePerBlock(uint256 _molePerBlock) external;
