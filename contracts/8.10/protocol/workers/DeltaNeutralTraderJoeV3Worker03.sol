...
/// @title DeltaNeutralTraderJoeV3Worker03 is a TraderJoeV2Worker03 worker with reinvest-optimized and beneficial vault buyback functionalities
contract DeltaNeutralTraderJoeV3Worker03 is OwnableUpgradeable, ReentrancyGuardUpgradeable, IWorker03 {
  /// @notice Libraries
  ...
  function initialize(
    ...
    pid = _pid;
    (ERC20Upgradeable _lpToken, , , ,) = masterChefJoeV3.poolInfo(_pid);
