...
/// @title TraderJoeBoostedWorker03e(expended) is a worker with reinvest-optimized and beneficial vault buyback functionalities
contract TraderJoeBoostedWorker03e is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker03 {
  /// @notice Libraries
  ...
  function initialize(
    ...
    pid = _pid;
    (IERC20 _lpToken, , , , , IRewarder _rewarder, , , ) = boostedMasterChefJoe.poolInfo(_pid);
  ...
  function shareToBalance(uint256 share) public view returns (uint256) {
    ...
    (uint256 totalBalance, , ) = boostedMasterChefJoe.userInfo(pid, address(this));
  ...
  function _reinvest(
    ...
    address(lpToken).safeApprove(address(boostedMasterChefJoe), uint256(-1));
    ...
    boostedMasterChefJoe.deposit(pid, lpToken.balanceOf(address(this)));
  ...
  function _removeShare(uint256 id) internal {
    ...
    if (share > 0) {
      ...
      boostedMasterChefJoe.withdraw(pid, balance);
