...
import "../../../utils/MoleMath.sol";

contract TraderJoeStrategyAddBaseTokenOnly is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  /// @notice This function is written base on fee=997, feeDenom=1000
  ...
  function execute(
    ...
    // Constants come from
    // 2-f = 2-0.003 = 1.997
    // 4(1-f) = 4*997*1000 = 3988000, where f = 0.0030 and 1,000 is a way to avoid floating point
    // 1997^2 = 3988009
    // 997*2 = 1994
    uint256 aIn = MoleMath.sqrt(rIn.mul(balance.mul(3988000).add(rIn.mul(3988009)))).sub(rIn.mul(1997)) / 1994;
