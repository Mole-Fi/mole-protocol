...
/// @title TraderJoeV3Worker03e(expended) is a worker with reinvest-optimized and beneficial vault buyback functionalities
contract TraderJoeV3Worker03e is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IWorker03 {
  /// @notice Libraries
  ...
  function initialize(
    ...
    pid = _pid;
    (IERC20 _lpToken, , , , IRewarder _rewarder) = masterChefJoeV3.poolInfo(_pid);
  ...
  function shareToBalance(uint256 share) public view returns (uint256) {
    ...
    (uint256 totalBalance, ) = masterChefJoeV3.userInfo(pid, address(this));
  ...
  function _reinvest(
    ...
    address(lpToken).safeApprove(address(masterChefJoeV3), uint256(-1));
    ...
    masterChefJoeV3.deposit(pid, lpToken.balanceOf(address(this)));
  ...
  function _removeShare(uint256 id) internal {
    ...
    if (share > 0) {
      ...
      masterChefJoeV3.withdraw(pid, balance);
