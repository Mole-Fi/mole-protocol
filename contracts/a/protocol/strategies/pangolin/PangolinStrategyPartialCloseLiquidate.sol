...
contract PangolinStrategyPartialCloseLiquidate is OwnableUpgradeSafe, ReentrancyGuardUpgradeSafe, IStrategy {
  ...
  event LogPangolinStrategyPartialCloseLiquidate(
  ...
  function execute(
    ...
    emit LogPangolinStrategyPartialCloseLiquidate(baseToken, farmingToken, lpTokenToLiquidate, lessDebt);
  }
